...
public abstract class AbstractMVVMFragment<V extends IView, VM extends IViewModel<V>, VDB extends ViewDataBinding> extends Fragment implements IExtendView<V, VM, VDB> {
